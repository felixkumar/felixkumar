...
registry.category("web_tour.tours").add('account_accountant_bank_rec_widget_ui',
    {
        ...
        },
        {
            ...
            extra_trigger: "tr.o_bank_rec_selected_line td[field='debit']:contains('$ 1,000.00')",
        ...
        },
        {
            ...
            extra_trigger: "tr.o_bank_rec_selected_line td[field='credit']:contains('$ 400.00')",
            trigger: ".o_list_record_remove .fa-trash-o",
        },
        {
        ...
        {
            content: "Modify the liquidity line amount",
            extra_trigger: "tr.o_bank_rec_selected_line td[field='debit']:contains('$ 222.22')",
            trigger: "div[name='amount_currency'] input",
            run: "text -333.33",
        },
        {
