...
class PosOrder(models.Model):
    ...
    def post_order_to_etims(self):
        ...
        if not error:
            ...
            if self.is_invoiced and self.account_move:
                ...
                template = self.env.ref(self.account_move._get_mail_template())
                self.account_move.with_context(skip_invoice_sync=True)._generate_pdf_and_send_invoice(template)
        else:
            self.write({
                'l10n_ke_order_json': content,
            })
    ...
    def _l10n_ke_oscu_get_json_from_order_lines(self):
        ...
        for index, line in enumerate(self.lines):
            ...
            # In case of a refund order, we have negative fields in the pos_order,
            # but eTims doesn't accept negative values, that's why we need to abs() some fields
    ...
    def _l10n_ke_oscu_json_from_pos_order(self):
        ...
        content = {
            ...
            'rcptTyCd': 'S' if not self.refunded_order_ids else 'R',        # Receipt code
            **taxable_amounts,
            **tax_amounts,
            **tax_rates,
    ...
    def get_l10n_ke_edi_oscu_pos_data(self):
        ...
        return {
            ...
            "refunded_order_ids": self.refunded_order_ids.ids,
        }
