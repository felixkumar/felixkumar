...
class ChileanReportCustomHandler(models.AbstractModel):
    ...
    def _dynamic_lines_generator(self, report, options, all_column_groups_expression_totals):
        ...
        # Subtotals line and fiscal year results line
        lines.extend([
            (0, self._create_report_total_line(report, options, subtotals_dict, _("Subtotal"), 2, markup="subtotals")),
            (0, self._create_report_total_line(report, options, fiscalyear_result_dict, _("Profit and Loss"), 3, markup="fiscalyear_result"))
        ])
