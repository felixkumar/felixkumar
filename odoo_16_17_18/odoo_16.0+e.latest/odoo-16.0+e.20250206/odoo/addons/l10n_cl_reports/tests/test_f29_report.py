    ...
    def test_whole_report(self):
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('Ventas Netas Gravadas IVA',                                         1000.0), # sales in accounts 310115 (products) and 310120 (services)
                ('Ventas Exentas',                                                        ''), # sales in travel vouchers 310122 (exempt of vat)
                ('Exportaciones',                                                         ''), # exports sales 310125 exempt of vat, and in a separate section of the declaration
    ...
    def test_report_external_values(self):
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('IVA Uso Comun',                                                         ''),
                ('IVA Compras Supermercado Uso Comun',                                    ''),
                ('IVA Compras Activo Fijo Destinados Ventas Exentas',                     23),  # fpp rate
                ('IVA Compras Activo Fijo Ventas Uso Comun',                              ''),
                ('IVA Compras Activo Fijo Ventas No Recuperables',                        ''),
                ('Totales',                                                               ''),
                ('IVA Credito Fiscal',                                                 228.0),
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('IVA Uso Comun',                                                         ''),
                ('IVA Compras Supermercado Uso Comun',                                    ''),
                ('IVA Compras Activo Fijo Destinados Ventas Exentas',                     46),  #
                ('IVA Compras Activo Fijo Ventas Uso Comun',                              ''),
                ('IVA Compras Activo Fijo Ventas No Recuperables',                        ''),
                ('Totales',                                                               ''),
                ('IVA Credito Fiscal',                                                 228.0),
