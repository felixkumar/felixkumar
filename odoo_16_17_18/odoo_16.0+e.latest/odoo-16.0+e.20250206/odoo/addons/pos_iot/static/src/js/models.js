...
const PosIotPosGlobalState = (PosGlobalState) => class PosIotPosGlobalState extends PosGlobalState {
    ...
    shouldInvoiceNewTab(actionRecord) {
        // Only download invoice in new tab if the report action isn't connect to an iot device.
        return super.shouldInvoiceNewTab(actionRecord) && !actionRecord.device_id;
    }
}
