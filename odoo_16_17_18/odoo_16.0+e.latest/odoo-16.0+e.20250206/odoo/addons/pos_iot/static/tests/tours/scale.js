...
Tour.register('pos_iot_scale_tour', {
    ...
    {
        content: "qty of 'Whiteboard Pen' should be 2.35",
        trigger: ".order-container .orderlines .orderline.selected .product-name:contains('Whiteboard Pen')",
        extra_trigger: ".order-container .orderlines .orderline.selected .product-name:contains('Whiteboard Pen') ~ .info-list .info em:contains('2.35')",
        run: function() {},
    }]);
});
