...
class TestJpkExport(TestAccountReportsCommon):
    ...
    @classmethod
    def setUpClass(cls, chart_template_ref='l10n_pl.pl_chart_template'):
        ...
        tax_importation = cls.env['account.tax'].search([('name', '=', 'Imp Tow'), ('company_id', '=', cls.company_data['company'].id)])
