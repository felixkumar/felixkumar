        ...
        if self.company_id.documents_account_settings:
            ...
            if setting:
                ...
                if doc:
                    ...
                    if 'default_res_id' in self._context and 'default_res_model' not in self._context:
                        # res_id and res_model will be set from the attachment
                        doc = doc.with_context(clean_context(self.env.context))
                    doc.create(values)
