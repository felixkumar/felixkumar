                ...
                def_field_values = new Promise(function (resolve, reject) {
                    ...
                    prom.then(function (openFieldDialog) {
                        if (!openFieldDialog) {
                            ...
                            const fieldDescr = {...field_description};
                            if (fieldDescr.type === "related") {
                                fieldDescr.filter = (f) => f.type !== "properties";
                            }
                            dialog = new NewFieldDialog(self, modelName, fieldDescr, _.filter(self.fields, {type: 'many2one'})).open();
