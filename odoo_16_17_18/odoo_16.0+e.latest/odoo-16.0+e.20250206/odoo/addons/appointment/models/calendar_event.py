    ...
    def action_cancel_meeting(self, partner_ids):
        ...
        if attendees:
            ...
            if len(self.attendee_ids - attendees) >= 2:
                ...
                # Remove partner after sending the message. We don't remove partners when we archive the event to notify
                # every attendees
                ...
                self.with_user(self.user_id or SUPERUSER_ID).action_archive()
