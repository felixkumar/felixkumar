...
QUnit.module('documents_kanban_tests.js', {
    async beforeEach() {
        ...
        const [documentsDocumentId1, documentsDocumentId2] = pyEnv['documents.document'].create([
            ...
            {
                available_rule_ids: [1], checksum: 'CHECKSUM-1', file_size: 20000, folder_id: documentsFolderIds[0], mimetype: 'application/pdf', name: 'blip',
        ...
        pyEnv['documents.document'].create([
            ...
            {
                checksum: 'CHECKSUM-2', file_size: 10000, folder_id: documentsFolderIds[0], mimetype: 'image/png', name: 'burp', owner_id: resUsersIds[0],
    ...
    QUnit.test('document inspector: document preview', async function (assert) {
        ...
        assert.containsOnce(target, '.o_AttachmentViewer  img[data-src="/web/image/4?model=documents.document&unique=CHECKSUM-2"]',
        ...
        const fileURL = encodeURIComponent('/web/content/2?model=documents.document&unique=CHECKSUM-1');
        assert.containsOnce(target, 'iframe[data-src="/web/static/lib/pdfjs/web/viewer.html?file=' + fileURL  + '"]',
