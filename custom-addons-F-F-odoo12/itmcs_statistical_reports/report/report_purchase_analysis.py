...
class ProfitAnalysisReport(models.AbstractModel):
    _name = 'report.itmcs_statistical_reports.report_purchaseanalysisreport'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('itmcs_statistical_reports.report_purchaseanalysisreport', values=docargs)
